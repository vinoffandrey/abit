...
(() => {
      ...
      732: function (e) {
        e.exports = (function () {
          ...
          var t = "undefined" != typeof window,
            ...
            U = function (e, t) {
              Z(e, u, C(e, t.data_sizes)),
                Z(e, c, C(e, t.data_srcset)),
  ...
  (() => {
    ...
    const I = {
      ...
      on: function (...e) {
        ...
        function o(e) {
          ...
          if ((n.indexOf(e) < 0 && n.unshift(e), E(t).is(i))) s.apply(t, n);
          else {
            const e = E(t).parents();
            for (let t = 0; t < e.length; t += 1)
              E(e[t]).is(i) && s.apply(e[t], n);
          }
        }
        function r(e) {
      ...
      is: function (e) {
        ...
        if ("string" == typeof e) {
          ...
          for (n = E(e), o = 0; o < n.length; o += 1) if (n[o] === s) return !0;
          return !1;
        }
        if (e === i) return s === i;
        if (e === t) return s === t;
    ...
    Object.keys(I).forEach((e) => {
      Object.defineProperty(E.fn, e, { value: I[e], writable: !0 });
    });
    const L = E;
    function O(e, t) {
    ...
    const R = {
      ...
      updateSlides: function () {
        ...
        if (
          ...
          P(e.wrapperEl, "--swiper-centered-offset-before", -h[0] + "px"),
            P(
              e.wrapperEl,
    ...
    const ne = {
        attachEvents: function () {
          ...
          (e.onTouchStart = Z.bind(e)),
            ...
            (e.onClick = J.bind(e)),
            s.touch && !te && (t.addEventListener("touchstart", ie), (te = !0)),
            se(e, "on");
        },
    ...
    function ve(e) {
      ...
      function c() {
        ...
        if (
          ("fraction" === i.type &&
            (o.find(fe(i.currentClass)).text(i.formatFractionCurrent(c + 1)),
            o.find(fe(i.totalClass)).text(i.formatFractionTotal(u))),
          "progressbar" === i.type)
        ) {
          let e;
      ...
      function u() {
        ...
        if ("bullets" === e.type) {
          ...
          s.html(o), (t.pagination.bullets = s.find(fe(e.bulletClass)));
        }
        "fraction" === e.type &&
          ((o = e.renderFraction
        ...
        return (
          ...
          (e.prototype.addSlideVideoInfo = function (e) {
            ...
            e.forEach(function (e, i) {
              (e.__slideVideoInfo = tt(e.src, !!e.video, i)),
                e.__slideVideoInfo &&
      ...
      ft = (function () {
        function e(e, t) {
          return (
            (this.core = e),
            (this.$LG = t),
            (this.settings = ot(ot({}, rt), this.core.settings)),
            this
          );
        }
        return (
          ...
          (e.prototype.init = function () {
            ...
            if (this.settings.zoom) {
              ...
              this.core.outer.on("dblclick.lg", function (t) {
                ...
                this.core.LGel.on(ut + ".zoom", function (t) {
      ...
      wt = (function () {
        function e(e, t) {
          return (
            (this.core = e),
            (this.$LG = t),
            (this.settings = yt(yt({}, bt), this.core.settings)),
            this
          );
        }
        return (
      ...
      zt = (function () {
        function e(e, t) {
          return (
            (this.core = e),
            (this.$LG = t),
            (this.settings = Ct(Ct({}, Ot), this.core.settings)),
            this
          );
        }
        return (
          ...
          (e.prototype.init = function () {
            ...
            this.settings.rotate &&
              ...
              this.core.LGel.on(xt + ".rotate", function (t) {
    ...
    const Mt = zt,
      $t = document.querySelectorAll("[data-gallery]");
    $t.length &&
      $t.forEach((e) => {
    ...
    (Ft.prototype._setActiveClass = function () {
      var e, t, i, s;
      ...
      (Ft.prototype._addIndicators = function () {
      ...
      (Ft.prototype._refreshExtremeValues = function () {
      ...
      (Ft.prototype._balancingItems = function () {
      ...
      (Ft.prototype._addEventListener = function () {
        var e = this._$items;
        function t(e) {
          this._autoplay("stop");
      ...
      (Ft.prototype.prev = function () {
        (this._direction = "prev"), this._move();
      }),
      (Ft.prototype.autoplay = function (e) {
        this._autoplay("stop");
      });
    ...
    Vt.length > 0 &&
      ...
      (function () {
        const e = document.querySelector(".checkbox__input"),
          ...
          i = document.querySelector(".checkbox__input2"),
          s = document.querySelector(".form__button");
        ...
        if (e.length > 0) {
          ...
          function a(e) {
            ...
            if (t.hasAttribute("data-spoller") || t.closest("[data-spoller]")) {
              const i = t.hasAttribute("data-spoller")
                  ? t
