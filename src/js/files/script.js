...
function checkboxFunction() {
	...
	const buttonClass = document.querySelector('.question__button');
	const checkboxInput2 = document.querySelector('.checkbox__input2');
	const buttonClass2 = document.querySelector('.form__button');

	checkboxInput.addEventListener('change', () => {
		buttonClass.classList.toggle('active');
	})

	checkboxInput2.addEventListener('change', () => {
		buttonClass2.classList.toggle('active');
	})
}
checkboxFunction();
